    ...
    languages: [
        ...
        new MLanguage('Rus').create({
            aboutMe: {
                ...
                about: 'Я Веб-Разработчик. В данный момент проживаю в Киеве, Украина. Сейчас работаю на фрилансе. Ищу работу на которой могу занятся интерессными проэктами и повысить свои навыки',
                phone: 'Телефон',
                email: 'Почта',
                address: 'Адрес',
            ...
            skills: {
                name: 'Навыки',
                desc: 'Моя мечта работать в компании с людьми, которые также вовлечены в розработку чего-то удивительного, как и я'
            },
            experience: {
                name: 'Опыт работы',
                desc: 'Я имею пол года опыта работы на фрилансе, также стараюсь себя занять интересными задачами в свободное время'
            },
            education: {
                name: 'Образование',
